...
* The SSR can have its duty cycle set directly or set via a PID loop using temperature as error parremeter.
* Note that the Teensy4.0 CPU speed must be set to 25 MHz for the 5-Hz PWM to work. 
**********************************************************************************************************/
#include <vector>
#include <tuple>
#include <string>
